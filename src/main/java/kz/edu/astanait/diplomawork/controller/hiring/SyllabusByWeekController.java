...
public class SyllabusByWeekController extends ExceptionHandling {
    ...
    public ResponseEntity<HttpStatus> createAll(@RequestBody List<SyllabusByWeekDtoRequest> syllabusByWeekDtoRequestList) {
