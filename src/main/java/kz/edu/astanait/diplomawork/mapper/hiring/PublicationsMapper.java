...
public class PublicationsMapper {
    ...
    public static PublicationsDtoResponse publicationsToDto(Publications publications) {
        ...
        if (Objects.nonNull(publications.getPublicationsType())) publicationsDtoResponse.setPublicationsTypeDtoResponse(PublicationsTypeMapper.publicationsTypeToDto(publications.getPublicationsType()));
