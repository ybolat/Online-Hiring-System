...
public class CommissionActionHistoryMapper {
    public static CommissionActionHistoryDtoResponse commissionActionHistoryToDto (CommissionActionHistory commissionActionHistory){
        ...
        if(Objects.nonNull(commissionActionHistory.getRequest())) commissionActionHistoryDtoResponse.setRequest(RequestMapper.requestToDto(commissionActionHistory.getRequest()));
        ...
        return commissionActionHistoryDtoResponse;
    }
}
